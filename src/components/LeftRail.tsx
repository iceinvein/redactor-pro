  ...
  return (
    <aside className="border-r border-default-200 bg-default-50/70 backdrop-blur supports-[backdrop-filter]:bg-default-50/50 p-3 flex flex-col gap-3 overflow-auto">
      ...
      {hasDocument && onUploadNew && (
        <Button size="sm" variant="flat" onPress={onUploadNew} isDisabled={isProcessing}>
      ...
      {/* Modes */}
      <div className="mt-1">
        <p className="text-[11px] uppercase tracking-wide text-default-500 mb-2">Modes</p>
      ...
      {/* Actions */}
      <div className="mt-2">
        <p className="text-[11px] uppercase tracking-wide text-default-500 mb-2">Actions</p>
        <div className="flex flex-col gap-2">
          <Button size="sm" variant="flat" color="danger" onPress={onClearAll} isDisabled={!hasDocument}>
            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
